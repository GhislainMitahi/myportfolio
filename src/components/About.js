...
const About = (props) => {
  return (
    <div className="flex-col bg-black text-white p-5 h-auto about" id="about">
      <h1 className="text-center text-5xl pt-4 text-primary titre-about">About Me</h1>
      <div className="flex mt-8 justify-center items-center w-full content-about">
        <div className="text-about md:w-2/4 flex gap-6 justify-center items-center flex-col ">
              <p className="sm:text-center  text-l md:pl-14 pt-4 ">
